...
// Embed subsetted fonts at compile time (generated by build.rs)
// These contain only ASCII printable + suit symbols + common accented characters
const DEJAVU_SANS: &[u8] = include_bytes!(concat!(env!("OUT_DIR"), "/DejaVuSans-subset.ttf"));
const DEJAVU_SANS_BOLD: &[u8] =
    include_bytes!(concat!(env!("OUT_DIR"), "/DejaVuSans-Bold-subset.ttf"));
const DEJAVU_SANS_OBLIQUE: &[u8] =
    include_bytes!(concat!(env!("OUT_DIR"), "/DejaVuSans-Oblique-subset.ttf"));

// TeX Gyre Termes (subsetted) - Times New Roman clone for professional typesetting
const TERMES_REGULAR: &[u8] = include_bytes!(concat!(
    env!("OUT_DIR"),
    "/texgyretermes-regular-subset.ttf"
));
const TERMES_BOLD: &[u8] =
    include_bytes!(concat!(env!("OUT_DIR"), "/texgyretermes-bold-subset.ttf"));
const TERMES_ITALIC: &[u8] =
    include_bytes!(concat!(env!("OUT_DIR"), "/texgyretermes-italic-subset.ttf"));
const TERMES_BOLD_ITALIC: &[u8] = include_bytes!(concat!(
    env!("OUT_DIR"),
